  ...
  <section class="content">
    ...
    <div class="card card-secondary card-outline">
      <div class="card-header">
        ...
        <a href="<?php echo base_url();?>Ventas/add" class="btn btn-xs btn-green pull-right">
 ...
 <?php if(!empty($ventas)):?>
   <?php foreach($ventas as $venta):?>
    ...
    <tr role="row" class="odd">
      ...
      <td>
        <button type="button" class="btn btn-default btn-view-venta fa fa-search" value="<?php echo $venta->idventas;?>" data-toggle="modal" data-target="#modal-default">
          Detalles
        </button>
      </td>
    </tr>
