  ...
  <section class="content">
    ...
    <div class="card card-secondary card-outline">
      <div class="card-header">
        ...
        <a href="<?php echo base_url();?>Clientes/add" class="btn btn-xs btn-green pull-right">
          <span class="fa fa-plus"></span>  Agregar Clientes 
        </a>
 ...
 <?php if(!empty($clientes)):?>
   <?php foreach($clientes as $cliente):?>
    ...
    <tr role="row" class="odd">
      ...
      <td>
        <a href="<?php echo base_url()?>Clientes/edit/<?php  echo $cliente->idcliente;?>" class="btn btn-sm btn-info" >
          <i class="fa fa-pencil">
          </i> EDITAR 
        </a>
        <a class="btn btn-sm btn-danger btn-remove" href="<?php echo base_url();?>Clientes/delete/<?php echo $cliente->idcliente;?>" title="ANULAR" onclick="">
          <i class="fa fa-trash">
          </i> ANULAR 
        </a>
      </td>
